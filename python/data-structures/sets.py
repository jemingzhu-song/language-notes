...
# ---------- Usage ---------- #
# Just as with tuples, a list can often be used where a set is being used, raising the question, "what are the 
# advantages of using sets rather than lists?" Besides the set operations union, intersection, and difference 
# available only to sets, the primary reason to use the set structure over the list structure is that it 
# guarantees the uniqueness of elements and unordered storage. While there may be some theoretical 
# efficiency to be gained in terms of how Python stores sets rather than lists, the primary reason 
# for using the set structure from a programming perspective should be to signal to anyone 
# reviewing your code that these properties are important.